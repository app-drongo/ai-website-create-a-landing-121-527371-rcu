  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Identity Verification", href: "/identity" },
        { name: "Risk Assessment", href: "/risk" },
        { name: "Financial Analytics", href: "/analytics" },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Powering the future of financial services with secure, compliant open banking APIs. 
